...
public class GOST256ClientSignatureVerifierProvider implements ClientSignatureVerifierProvider {

    private final KeycloakSession session;

    public GOST256ClientSignatureVerifierProvider(KeycloakSession session) {
